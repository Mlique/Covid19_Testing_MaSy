...
<body data-layout="horizontal" data-topbar="colored">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user" src="../assets/images/users/usericon.png"
                                alt="Header Avatar">
                            <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-15">Manager
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none"
                                        href="#" id="topnav-uielement"
                                        role="button">
                                        <i class="uil-flask me-2"></i>Nurses
                                    </a>
                                </li>

                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="{{ route('nurse_suburb.index') }}" id="topnav-pages"
                                        role="button">
                                        <i class="uil-apps me-2"></i>Nurse Favourite Suburb
                                    </a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages"
                                        role="button">
                                        <i class="uil-apps me-2"></i>Lab Users
                                    </a>
                                </li>
    ...
    <script src="{{ URL::to('admin_assets/js/pages/datatables.init.js') }}"></script>
     ...
     <script src="{{ URL::to('admin_assets/libs/datatables.net/js/jquery.dataTables.min.js') }}"></script>
     <script src="{{ URL::to('admin_assets/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js') }}"></script>
     <script src="{{ URL::to('admin_assets/js/pages/ecommerce-datatables.init.js') }}"></script>
